    ...
    <div class="col-md-2">
        <div class="form-floating mb-3">
            <input type="text"
                ...
                value="<?= old('postalcode', $teacher->address->postalcode) ?>">
    ...
    <div class="col-md-8">
        <div class="form-floating mb-3">
            <input type="text"
                ...
                id="street"
                placeholder="Rua"
                value="<?= old('street', $teacher->address->street) ?>">
    ...
    <div class="col-md-2">
        <div class="form-floating mb-3">
            <input type="text"
                ...
                id="number"
                placeholder="Número"
                value="<?= old('number', $teacher->address->number) ?>">
    ...
    <div class="col-md">
        <div class="form-floating mb-3">
            <input type="text"
                ...
                id="city"
                placeholder="Cidade"
                value="<?= old('city', $teacher->address->city) ?>">
    ...
    <div class="col-md">
        <div class="form-floating mb-3">
            <input type="text"
                ...
                id="district"
                placeholder="Bairro"
                value="<?= old('district', $teacher->address->district) ?>">
    ...
    <div class="col-md">
        <div class="form-floating mb-3">
            <input type="text"
                ...
                id="state"
                placeholder="Estado"
                value="<?= old('state', $teacher->address->state) ?>">
