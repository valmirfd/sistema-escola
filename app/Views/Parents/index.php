    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <a class="btn bg-gradient-dark btn-sm mb-0 float-start" href="<?= route_to('parents.new'); ?>">
                            ...
                            <?php foreach ($parents as $parent): ?>
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="d-flex align-items-start justify-content-start">
                                            <div>
                                                <h6 class="mb-0 text-sm"><?= $parent->email; ?></h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="align-middle text-center">
                                        <div class="d-flex align-items-start justify-content-start">
                                            <div>
                                                <h6 class="mb-0 text-sm"><?= $parent->cpf; ?></h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="align-middle text-center">
